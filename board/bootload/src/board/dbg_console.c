...
#warning Please use UART4 pins for debug consol as UART0 pins are used in SSC audio for SAM V71 Xplained Ultra board
...
/** Pins description corresponding to Rxd,Txd, (UART pins) */
#define CONSOLE_PINS        {PIN_USART1_RXD, PIN_USART1_TXD}
