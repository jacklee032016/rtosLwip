...
#ifndef __MUX_HTTP_FILESYSTEM_H__
#define __MUX_HTTP_FILESYSTEM_H__

#include "lwip/apps/muxHttpOpts.h"
#include "lwip/err.h"

#if MHTTPD_PRECALCULATED_CHECKSUM
struct 	mhttpdata_chksum
{
	u32_t	offset;
	u16_t	chksum;
	u16_t	len;
...
#if MHTTPD_PRECALCULATED_CHECKSUM
	u16_t						chksum_count;
	const struct mhttpdata_chksum	*chksum;
#endif
};
