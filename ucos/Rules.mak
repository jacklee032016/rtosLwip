...
BSP_HOME:=$(RULE_DIR)libs/bsp
UCOS_HOME:=$(RULE_DIR)/libs/os3
...
CFLAGS += -DROOT_DIR='"$(ROOT_DIR)"' -I$(ROOT_DIR) -I$(ROOT_DIR)/include -DLWIP_DEBUG
...
ASM_FLAGS += -mthumb -mcpu=cortex-m7 -mfloat-abi=softfp -mfpu=fpv5-sp-d16 \
