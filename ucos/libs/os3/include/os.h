...
#endif
#if (OS_CFG_DBG_EN == DEF_ENABLED)
    CPU_CHAR    const   *NamePtr;                           /* Pointer to Event Flag Name (NUL terminated ASCII)      */
#endif
...
#endif
#if (OS_CFG_DBG_EN == DEF_ENABLED)
    CPU_CHAR  const     *NamePtr;                           /* Pointer to Semaphore Name (NUL terminated ASCII)       */
#endif
...
#if (OS_CFG_DBG_EN == DEF_ENABLED)
    CPU_CHAR  const     *NamePtr;                           /* Pointer to task name                                   */
#endif
