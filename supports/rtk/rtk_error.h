...
extern const char * rtk_errMsg_get(int32 errCode);
/*
...
typedef enum rt_error_code_e
{
    ...
    RT_ERR_NO_ACK,                                  /* 0x00000017, I2C slave does not output ACK signal                                 */
    ...
    RT_ERR_STP_BRIDGE_PRIORITY,                     /* 0x00030004, invalid bridge priority                                                      */
    RT_ERR_STP_FORWARDDELAY,                        /* 0x00030005, invalid forward delay                                                      */
    RT_ERR_STP_MAXAGE,                              /* 0x00030006, invalid max age                                                     */
    RT_ERR_STP_HELLOTIME,                           /* 0x00030007, invalid hello time                                                      */
    RT_ERR_STP_PORT_PRIORITY,                       /* 0x00030008, invalid port priority                                                      */
    RT_ERR_STP_PORT_PATH_COST,                      /* 0x00030009, invalid port path cost                                                      */
    RT_ERR_STP_PARAMETER_CHANGE_INT_CLEAR,                     /* 0x0003000a, invalid port path cost                                                      */
    RT_ERR_STP_PARAMETER_CHANGE_INT_DONE,                      /* 0x0003000b, invalid port path cost                                                      */
    ...
    RT_ERR_FILTER_ACTION_NUMBER,                    /* 0x00070011, too many ACL action types                */    
    RT_ERR_FILTER_ACTION_NOTFOUND,                  /* 0x00070012, ACL action not found               */    
    RT_ERR_FILTER_RULEFIELD_NO,                     /* 0x00070013, ACL rule field number error               */    
    RT_ERR_FILTER_RULEFIELD_NOTFOUND,               /* 0x00070014, ACL rule field number not found in rule              */    
    RT_ERR_FILTER_RULEAPPLY_FAILED,                 /* 0x00070015, Apply ACL rule to ASIC failed              */  
    RT_ERR_FILTER_ACTIONAPPLY_FAILED,               /* 0x00070016, Apply ACL action to ASIC failed              */  
    RT_ERR_FILTER_REVERSE,                                       /* 0x00070017, Apply ACL hit reverse to ASIC failed              */ 
    RT_ERR_FILTER_POLICER_NOTFOUND,                  /* 0x00070018, policer entry not found  */
    RT_ERR_FILTER_COUNTER_NOTFOUND,                 /* 0x00070019, counter entry not found*/
    ...
    RT_ERR_QOS_SEL_PRI_GROUP,                       /* 0x000d000b, invalid selection of table index                                      */
    RT_ERR_QOS_1P_DEI,                              /* 0x000d000c, invalid dei                                      */
    RT_ERR_QOS_SCHEDULE,                            /* 0x000d000d, illegal schedule                             */
    RT_ERR_QOS_INGRESS_LEAKY,                       /* 0x000d000e, invalid ingress leaky buket id                          */
    RT_ERR_QOS_RATE,                                /* 0x000d000f, invalid rate                       */
    ...
    RT_ERR_MAC_FORCE_1000,                          /* 0x000e0009, invalid force mac to 1000Mbps                                        */
    ...
    /* 0x0012xxxx for WOL */
    RT_ERR_WOL_INVALID_NODEID = 0x00120000,         /* 0x00120000, Invalid node id                                                      */
    RT_ERR_WOL_CPU_PORT_NOT_EN,                     /* 0x00120001, port is not configured as cpu port                                   */
