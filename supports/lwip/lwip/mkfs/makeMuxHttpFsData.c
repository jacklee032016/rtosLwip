...
#include "lwip/apps/muxHttpApp.h"
#include "lwip/apps/muxHttpHeadData.c"
...
#define	MK_OUT_FILE					"muxHttpFsData.c"
...
//	printf("     extended by Simon Goldschmidt  - 2009 " HTTP_NEWLINE HTTP_NEWLINE);
	...
	fprintf(data_file, "#include \"lwip/apps/muxHttpApp.h\"" HTTP_NEWLINE);
