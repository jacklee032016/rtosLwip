...
enum
{
	PTP_INITIALIZING = 0,
	PTP_FAULTY,
	PTP_DISABLED,		/* allows removal of a clock */
	PTP_LISTENING,		/* orderlay addition of clocks to net */
	PTP_PRE_MASTER,
	PTP_MASTER,
	PTP_PASSIVE,		/* used to segment network */
	PTP_UNCALIBRATED,	/* transition state to SLAVE */
	PTP_SLAVE
};
